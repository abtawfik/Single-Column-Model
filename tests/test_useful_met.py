...
'''
Read in some data that is used for all testing
'''
nlev      =  27
...
### PBL_THETA should equal 322.5 in this case
### Do a check for PBLH and PBLP with synthetic data as well

'''
Test somethings about the pblHeat subroutine
'''
def test_pbl_heat():
    pblHeat ( nlev1, missing, Theta, ppack, hpack, pblp, pbl_theta, pblh )
